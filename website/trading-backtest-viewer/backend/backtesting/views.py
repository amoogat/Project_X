...
def upload_file(request):
    try:
        ...
        Correct Output: [Close PARA Bullish]

        Text: If $META closes above 450, I will do 1,000 jumping jack
